...
#include "ir_remote_control.h"   /* Библиотека общения в ИК-диапазоне (для улавливания нажатия кнопок) */
#include "fast_fifo.h"           /* Библиотека, в которой содержится логика работы FIFO */
